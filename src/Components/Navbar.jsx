      ...
      <div className="container flex justify-between h-16 mx-auto">
        ...
        >
          ...
          >
            ...
            <g transform="matrix(0.75,0,0,0.75,249.78667664670684,-0.21332335329350371)">
              <svg
                viewBox="0 0 334 334"
                  ...
                  >
                    ...
                    <g>
                      ...
                      >
                        ...
                        <g transform="matrix(1,0,0,1,66.95384477197737,71.17305217166896)">
                          <svg
                            viewBox="0 0 199.99685602654029 191.55844122715712"
                            height="191.55844122715712"
                            width="199.99685602654029"
                          >
                            <g>
                              <svg
                                viewBox="0 0 213.1584412271571 204.16470312146413"
                                height="191.55844122715712"
                                width="199.99685602654029"
                              >
                                <g transform="matrix(1,0,0,1,0,126.1819772107327)">
                                  <svg
                                    viewBox="0 0 213.1584412271571 77.98272591073145"
                                    height="77.98272591073145"
                                ...
                                <g transform="matrix(1,0,0,1,52.05819962416751,0)">
                                  <svg
                                    viewBox="0 0 109.0420419788221 107.77212720863086"
                                    height="107.77212720863086"
                                    width="109.0420419788221"
                                  >
                                    <g>
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        data-name="outline cut copy"
                                        viewBox="1.293 2 60.707 60.00000007084449"
                                        x="0"
                                        y="0"
                                        height="107.77212720863086"
                                        width="109.0420419788221"
                                      ...
                                      >
                                        ...
                                        ></path>
                                        <path
                                          d="M35.634 44.368L36.626 42.63A42.9 42.9 0 0 0 15.4 37H2V39H15.4A40.9 40.9 0 0 1 35.634 44.368"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                        <path
                                          d="M32.474 49.88A57.76 57.76 0 0 1 59.765 43H62V41H60.414L61.707 39.707 60.293 38.293 59 39.586V37.414L61.707 34.707 60.293 33.293 59 34.586V32H57V34.586L55.707 33.293 54.293 34.707 57 37.414V39.586L55.707 38.293 54.293 39.707 55.729 41.143A59.8 59.8 0 0 0 31.529 48.12Z"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                        <path
                                          d="M24.746 50.349A1 1 0 0 0 24.433 50.111 1 1 0 0 0 24.333 50.059L16.356 47.066A1.01 1.01 0 0 0 15.223 47.378L7.223 57.378A1 1 0 0 0 7.652 58.94L15.652 61.94C15.663 61.94 15.674 61.94 15.685 61.945A1 1 0 0 0 16 62H32A1 1 0 0 0 32.781 60.375L24.781 50.375C24.772 50.364 24.756 50.36 24.746 50.349M25 55V53.851L29.912 59.991A5 5 0 0 1 25 55M18.088 59.991L23 53.851V55A5 5 0 0 1 18.088 59.991M16.328 49.191L22.358 51.452 15.672 59.809 9.643 57.548ZM22.893 60A7 7 0 0 0 24 58.6 7 7 0 0 0 25.107 60Z"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                        <path
                                          d="M37 62H45V60H43.264A4.15 4.15 0 0 0 43.014 55.167L42.548 54.584A2.16 2.16 0 0 1 42.707 51.707L41.293 50.293A4.15 4.15 0 0 0 40.228 54.358L39.528 55.058A4.11 4.11 0 0 0 38.841 60H37ZM40.941 56.473L41.25 56.164 41.45 56.416A2.16 2.16 0 0 1 41.291 59.293L41 59.586 40.941 59.527A2.16 2.16 0 0 1 40.941 56.473"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                        <path
                                          d="M28 12A5 5 0 1 0 23 7 5.006 5.006 0 0 0 28 12M28 4A3 3 0 1 1 25 7 3 3 0 0 1 28 4"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                        <path
                                          d="M42 16A4 4 0 0 0 44.8 14.84 4.964 4.964 0 0 0 51.733 14.296 3.992 3.992 0 0 0 58.969 12.468 3.5 3.5 0 0 0 58.5 5.5 3.5 3.5 0 0 0 57.575 5.626 4.485 4.485 0 0 0 49.865 4.849 4.988 4.988 0 0 0 41 8V8.126A4 4 0 0 0 42 16M41.942 10C41.972 10 42.067 10.014 42.098 10.016A1 1 0 0 0 43.113 8.761 3 3 0 0 1 43 8 2.989 2.989 0 0 1 48.959 7.646 1.12 1.12 0 0 0 49.502 8.422 1 1 0 0 0 51.002 7.558 1 1 0 0 0 50.996 7.458 2.491 2.491 0 0 1 55.958 7.179 1 1 0 0 0 57.571 7.835 1.5 1.5 0 1 1 58.5 10.5 1.6 1.6 0 0 1 58.164 10.458 1 1 0 0 0 56.964 11.625 2 2 0 0 1 57 12 1.993 1.993 0 0 1 53.122 12.653 1.09 1.09 0 0 0 52.1 12H52A1 1 0 0 1 51.743 11.958 1 1 0 0 0 50.611 12.44 2.978 2.978 0 0 1 45.532 12.7 0.98 0.98 0 0 0 44.632 12.272 1 1 0 0 0 43.81 12.843 1.98 1.98 0 0 1 42 14 2 2 0 0 1 41.942 10"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                        <path
                                          d="M6.5 16A3.45 3.45 0 0 0 8.537 15.336 5 5 0 0 0 13.654 15.227 3.96 3.96 0 0 0 16 16 4 4 0 0 0 16 8 3.8 3.8 0 0 0 15.072 8.114 4.984 4.984 0 0 0 6.425 9 3.5 3.5 0 0 0 6.5 16M6.5 11A1.5 1.5 0 0 1 6.869 11.055 1 1 0 0 0 8.089 10.314 2.987 2.987 0 0 1 13.722 9.759 1 1 0 0 0 15.09 10.233 2 2 0 1 1 14.479 13.278 1 1 0 0 0 13.779 12.924H13.718A1 1 0 0 0 13.037 13.192 2.943 2.943 0 0 1 9.089 13.292 1 1 0 0 0 7.667 13.434 1.5 1.5 0 1 1 6.5 11"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                        <path
                                          d="M43 28H39A1 1 0 0 0 38.2 28.4L35.5 32H33A1 1 0 0 0 32.2 32.4L29.2 36.4 30.8 37.6 33.5 34H36A1 1 0 0 0 36.8 33.6L39.5 30H43Z"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                        <path
                                          d="M2.707 46.293L1.293 47.707 4.293 50.707A1 1 0 0 0 5.707 50.707L8.707 47.707 7.293 46.293 6 47.586V45.414L8.707 42.707 7.293 41.293 6 42.586V40H4V42.586L2.707 41.293 1.293 42.707 4 45.414V47.586Z"
                                          fill="#ffffff"
                                          data-fill-palette-color="quaternary"
                                        ></path>
                                      </svg>
